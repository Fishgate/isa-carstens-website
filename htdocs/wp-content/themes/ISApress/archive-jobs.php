                                                                            ...
                                                                            <section class="entry-content clearfix" itemprop="articleBody">
                                                                                ...
                                                                                <?php $i=1; while (have_posts()) : the_post(); ?>
                                                                                    ...
                                                                                    <div class="left col-6-entry arc-single">
                                                                                        <h3><?php the_title(); ?></h3>
                                                                                        Location: <?php echo do_shortcode('[wpuf-meta name="position_location"]'); ?><br />
                                                                                        <?php if(do_shortcode('[wpuf-meta name="earning_potential"]')  != "" ) { ?>Earning Potential: <?php echo do_shortcode('[wpuf-meta name="earning_potential"]'); ?><?php }; ?>
