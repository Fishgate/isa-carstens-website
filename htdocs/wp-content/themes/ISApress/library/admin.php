...
function bones_custom_admin_footer() {
    _e( '<span id="footer-thankyou">Developed by <a href="http://fishgate.co.za" target="_blank">Fishgate</a>. Powered by <a href="http://wordpress.org" target="_blank">Wordpress</a>.</span>', 'bonestheme' );
}
