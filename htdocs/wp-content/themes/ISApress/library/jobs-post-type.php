...
function custom_post_jobs() { 
	...
	register_post_type( 'jobs', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'view_item' => __( 'View Jobs', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search Jobs', 'bonestheme' ), /* Search Custom Type Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'Jobs post type for Isa Carstens!', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/briefcase.png', /* the icon for the custom post type menu */
	...
	add_action( 'init', 'custom_post_jobs');
        ...
        add_filter( 'enter_title_here', 'change_default_title_jobs' );

        function change_default_title_jobs( $title ){
