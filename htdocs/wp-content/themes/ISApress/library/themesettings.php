<?php
    ...
    if(isset($_POST['update_settings']) && $_POST['update_settings'] == true) {
        ...
        update_option('feature_news',  esc_attr($_POST['feature_news']));
    }
                    ...
                    <form action="" method="post">
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input <?php if ( get_option('feature_news') == "on" ) echo "checked"; ?> type="checkbox" name="feature_news" id="news_checkbox" class="checkbox">
                                    <label for="news_checkbox">Show featured image for the "Latest News" feature on the home page<br /><span class="description">Featured image needs to be at least 1920x602 pixels to display properly on the home page banner</span></label>
                                </td>
                            </tr> 
                        </table>
