...
if(!$soma_newsdata->prep_data() || get_option('feature_soma') != "on") {
    ...
    $soma_newsdata->title = 'Somatology<br />Spa Reception (New)';
    ...
    //$soma_newsdata->excerpt = 'Applications for 2015 for both open.';
    ...
    $soma_newsdata->large_img_url = get_template_directory_uri() . '/library/images/spa-reception.jpg';

    // latest post small image url
    //$soma_newsdata->small_img_url = get_template_directory_uri() . '/library/images/somatology_thumb.jpg';
    $soma_newsdata->small_img_url = get_template_directory_uri() . '/library/images/spa-reception-thumb.jpg';
